...
# 1.Отладка Без ТПО (только ЗОСРВ и Драйвера)  
# - необходимо в Libraries убрать tpo5_iface_tms6416.lib
# - раскоментарить в строке 180 данного файла функцию os_main
# 2.Отладка с ТПО  
# - добавить библиотеку tpo5_iface_tms6416.lib
# - закоментарить функцию os_main  ,теперь она должна быть вызвана в tpo 
#
# 
# > 
*/
...
// ---------------------------------------------------------------------------
// Заглушка для тестирования ОС и драйверов без ТПО нужно тогда удалить библиотеку ТПО tpo_16_iface.lib
