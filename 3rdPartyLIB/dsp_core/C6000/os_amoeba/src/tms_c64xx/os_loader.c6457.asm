...
; Этот код скорее всего не понадобится для c6457, однако если понадобится
; учите, что при старте процессор будет пахать на частоте генератора, а не на
; 1 GHz, так что задержку придется подбирать на месте (при раскоментаривании не забудь
; закоментарить блок NOP'ов)
