...
*        ..                                       All rights reserved.                                               *
***********************************************************************************************************************
* Module      : drv_ipmp.dsp-15.comm.cpp
* Description : 
* Author      : 
******************************************************************************
******************************************************************************
...
// ---------------------------------------------------------------------------
int32 ipmp_dsp15_comm_open( s_os_driver_descriptor* d, uint16 access )
{
  return -1;
}
// ---------------------------------------------------------------------------
int32 ipmp_dsp15_comm_close( s_os_driver_descriptor* d )
{
  return -1;
}
// ---------------------------------------------------------------------------
int32 ipmp_dsp15_comm_read( s_os_driver_descriptor* d, void* buf, int32 length )
{
  return -1;
}
// ---------------------------------------------------------------------------
int32 ipmp_dsp15_comm_write( s_os_driver_descriptor* d, const void* buf, int32 length )
{
  return -1;
}

/*****************************************************************************
Syntax:  int32 ipmp_dsp15_comm_ioctl( s_os_driver_descriptor* d, int32 cmd, const void* arg )    	    
Remarks:			    
*******************************************************************************/
int32 ipmp_dsp15_comm_ioctl( s_os_driver_descriptor* d, int32 cmd, const void* arg )
{
  switch( cmd )
  {
    ...
    case IOC_INIT:
    {
      ...
      pattr.stack = 512;
      tx_process = prc_create( &ipmp_dsp15_tx_process, NULL, 0, &pattr );
      rx_process = prc_create( &ipmp_dsp15_rx_process, NULL, 0, &pattr );
...
// ---------------------------------------------------------------------------
int32 drv_ipmp_dsp15_plug( const char* path, uint32 i0_d, uint32 i1_d )
{
  ...
  res_share( int0_d );
  res_share( int1_d );
  return drv_plug( path, INOT_FILE, &ipmp_dsp15_comm_open, &ipmp_dsp15_comm_close, &ipmp_dsp15_comm_read, &ipmp_dsp15_comm_write, &ipmp_dsp15_comm_ioctl, NULL, 0 );
}
/*****************************************************************************
Syntax:      	    
Remarks:			    
*******************************************************************************/
int32 drv_ipmp_dsp15_plug( const char* path )
{
  int0_d = RES_VOID;
  int1_d = RES_VOID;
  return drv_plug( path, INOT_FILE, &ipmp_dsp15_comm_open, &ipmp_dsp15_comm_close, &ipmp_dsp15_comm_read, &ipmp_dsp15_comm_write, &ipmp_dsp15_comm_ioctl, NULL, 0 );
