...
// !: d: переферийного процессора m448-15.
// ---------------------------------------------------------------------------
#include <os.h>
#include <emif.h>
...
#define EA_GBL_CTL_HOLDA       0                //R
    ...
    //CE0 Space:
#define EA_CE_CTL_0_MTYPE      CECTL_ASYNC32
#define EA_CE_CTL_0_RDSTRB     10
#define EA_CE_CTL_0_RDSETUP    2
#define EA_CE_CTL_0_RDHLD      2
#define EA_CE_CTL_0_WRSTRB     10
#define EA_CE_CTL_0_WRSETUP    2    
#define EA_CE_CTL_0_WRHLD      2
#define EA_CE_CTL_0_WRHLDMSB   0
#define EA_CE_CTL_0_TA         2
#define EA_CE_SEC_0_SYNCRL     CESEC_2CYCLE
...
#define EA_CE_SEC_1_SNCCLK     CESEC_ECLKOUT1
    ...
    //CE2 Space:
#define EA_CE_CTL_2_MTYPE      CECTL_ASYNC8
#define EA_CE_CTL_2_RDSTRB     63
#define EA_CE_CTL_2_RDSETUP    15
#define EA_CE_CTL_2_RDHLD      3
#define EA_CE_CTL_2_WRSTRB     63
#define EA_CE_CTL_2_WRSETUP    15   
#define EA_CE_CTL_2_WRHLD      3
#define EA_CE_CTL_2_WRHLDMSB   0
#define EA_CE_CTL_2_TA         3
#define EA_CE_SEC_2_SYNCRL     CESEC_2CYCLE
#define EA_CE_SEC_2_SYNCWL     CESEC_0CYCLE
#define EA_CE_SEC_2_CEEXT      CESEC_INACTIVE
#define EA_CE_SEC_2_RENEN      CESEC_ADS
#define EA_CE_SEC_2_SNCCLK     CESEC_ECLKOUT1
    
    //CE3 Space:
#define EA_CE_CTL_3_MTYPE      CECTL_ASYNC8
...
#define EA_CE_SEC_3_SYNCRL     CESEC_2CYCLE
...
#define EB_CE_SEC_2_SNCCLK     CESEC_ECLKOUT1
    ...
    //CE3 Space:
#define EB_CE_CTL_3_MTYPE      CECTL_ASYNC16
#define EB_CE_CTL_3_RDSTRB     10//9
#define EB_CE_CTL_3_RDSETUP    2//1
#define EB_CE_CTL_3_RDHLD      2//1
#define EB_CE_CTL_3_WRSTRB     6//5
#define EB_CE_CTL_3_WRSETUP    2//1  
#define EB_CE_CTL_3_WRHLD      2//1
#define EB_CE_CTL_3_WRHLDMSB   0//0
#define EB_CE_CTL_3_TA         2//3
...
{
  { NULL, SYSCALL_EMIF_INIT, (uint32)&emif_m448_15_iface_init }
};
