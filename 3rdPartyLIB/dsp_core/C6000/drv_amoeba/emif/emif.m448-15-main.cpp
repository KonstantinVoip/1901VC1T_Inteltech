...
// !: d: центрального процессора m448-15.
// ---------------------------------------------------------------------------
#include <os.h>
#include <emif.h>
#include <drv_dnsd.h>
...
#define EA_GBL_CTL_HOLDA       0                //R
    ...
    //CE0 Space:
#define EA_CE_CTL_0_MTYPE      CECTL_SDRAM32
#define EA_CE_CTL_0_RDSTRB     0
#define EA_CE_CTL_0_RDSETUP    0
#define EA_CE_CTL_0_RDHLD      0
#define EA_CE_CTL_0_WRSTRB     0
#define EA_CE_CTL_0_WRSETUP    0    
#define EA_CE_CTL_0_WRHLD      0
#define EA_CE_CTL_0_WRHLDMSB   0
#define EA_CE_CTL_0_TA         3
#define EA_CE_SEC_0_SYNCRL     CESEC_0CYCLE
#define EA_CE_SEC_0_SYNCWL     CESEC_0CYCLE
#define EA_CE_SEC_0_CEEXT      CESEC_INACTIVE
#define EA_CE_SEC_0_RENEN      CESEC_ADS
#define EA_CE_SEC_0_SNCCLK     CESEC_ECLKOUT1
    
    //CE1 Space:
#define EA_CE_CTL_1_MTYPE      CECTL_SYNC32
#define EA_CE_CTL_1_RDSTRB     1
#define EA_CE_CTL_1_RDSETUP    0
#define EA_CE_CTL_1_RDHLD      0
#define EA_CE_CTL_1_WRSTRB     1
#define EA_CE_CTL_1_WRSETUP    0    
#define EA_CE_CTL_1_WRHLD      0
#define EA_CE_CTL_1_WRHLDMSB   0
#define EA_CE_CTL_1_TA         1
#define EA_CE_SEC_1_SYNCRL     CESEC_0CYCLE//CESEC_1CYCLE
#define EA_CE_SEC_1_SYNCWL     CESEC_0CYCLE
#define EA_CE_SEC_1_CEEXT      CESEC_INACTIVE//CESEC_ACTIVE
#define EA_CE_SEC_1_RENEN      CESEC_ADS
#define EA_CE_SEC_1_SNCCLK     CESEC_ECLKOUT2
    
    //CE2 Space:
#define EA_CE_CTL_2_MTYPE      CECTL_SYNC32
#define EA_CE_CTL_2_RDSTRB     1
#define EA_CE_CTL_2_RDSETUP    0
#define EA_CE_CTL_2_RDHLD      0
#define EA_CE_CTL_2_WRSTRB     1
#define EA_CE_CTL_2_WRSETUP    0   
#define EA_CE_CTL_2_WRHLD      0
#define EA_CE_CTL_2_WRHLDMSB   0
#define EA_CE_CTL_2_TA         1
#define EA_CE_SEC_2_SYNCRL     CESEC_0CYCLE//CESEC_1CYCLE
#define EA_CE_SEC_2_SYNCWL     CESEC_0CYCLE
#define EA_CE_SEC_2_CEEXT      CESEC_INACTIVE//CESEC_ACTIVE
#define EA_CE_SEC_2_RENEN      CESEC_ADS
#define EA_CE_SEC_2_SNCCLK     CESEC_ECLKOUT2
    
    //CE3 Space:
#define EA_CE_CTL_3_MTYPE      CECTL_ASYNC32
#define EA_CE_CTL_3_RDSTRB     63
#define EA_CE_CTL_3_RDSETUP    15
#define EA_CE_CTL_3_RDHLD      3
#define EA_CE_CTL_3_WRSTRB     63
#define EA_CE_CTL_3_WRSETUP    15   
#define EA_CE_CTL_3_WRHLD      3
#define EA_CE_CTL_3_WRHLDMSB   0
#define EA_CE_CTL_3_TA         3
#define EA_CE_SEC_3_SYNCRL     CESEC_0CYCLE
#define EA_CE_SEC_3_SYNCWL     CESEC_0CYCLE
#define EA_CE_SEC_3_CEEXT      CESEC_INACTIVE
#define EA_CE_SEC_3_RENEN      CESEC_ADS
#define EA_CE_SEC_3_SNCCLK     CESEC_ECLKOUT1
    
    //SDRAM Control:
#define EA_SDRAM_CTL_TRC       5
#define EA_SDRAM_CTL_TRP       1
#define EA_SDRAM_CTL_TRCD      1
#define EA_SDRAM_CTL_INITI     SDCTL_YES 
#define EA_SDRAM_CTL_RFEN      SDCTL_ENABLE 
#define EA_SDRAM_CTL_SDCSZ     SDCTL_8COL 
#define EA_SDRAM_CTL_SDRSZ     SDCTL_11ROW 
#define EA_SDRAM_CTL_SDBSZ     SDCTL_4BANKS 
#define EA_SDRAM_CTL_SLFRFR    SDCTL_DISABLE
#define EA_SDRAM_TIM_CNTR      0                //R
#define EA_SDRAM_TIM_PERIOD    1872
#define EA_SDRAM_TIM_XRFR      SDTIM_2REFR_1h
    
    //SDRAM More Options:
#define EA_SDRAM_EXT_TCL       3
#define EA_SDRAM_EXT_TRAS      7
#define EA_SDRAM_EXT_TRRD      2 
#define EA_SDRAM_EXT_TWR       3
#define EA_SDRAM_EXT_THZP      3
#define EA_SDRAM_EXT_RD2RD     2
#define EA_SDRAM_EXT_RD2DEAC   4
#define EA_SDRAM_EXT_RD2WR     3
#define EA_SDRAM_EXT_R2WDQM    4
#define EA_SDRAM_EXT_WR2WR     2
#define EA_SDRAM_EXT_WR2DEAC   4
...
#define EB_CE_CTL_0_RDSTRB     10
#define EB_CE_CTL_0_RDSETUP    2
#define EB_CE_CTL_0_RDHLD      2
#define EB_CE_CTL_0_WRSTRB     6
#define EB_CE_CTL_0_WRSETUP    2    
#define EB_CE_CTL_0_WRHLD      2
#define EB_CE_CTL_0_WRHLDMSB   0
#define EB_CE_CTL_0_TA         2
#define EB_CE_SEC_0_SYNCRL     CESEC_2CYCLE
#define EB_CE_SEC_0_SYNCWL     CESEC_0CYCLE
#define EB_CE_SEC_0_CEEXT      CESEC_INACTIVE
#define EB_CE_SEC_0_RENEN      CESEC_ADS
#define EB_CE_SEC_0_SNCCLK     CESEC_ECLKOUT1
    
    //CE1 Space:
#define EB_CE_CTL_1_MTYPE      CECTL_ASYNC8
#define EB_CE_CTL_1_RDSTRB     25//15//10
#define EB_CE_CTL_1_RDSETUP    2//2
#define EB_CE_CTL_1_RDHLD      2//1
#define EB_CE_CTL_1_WRSTRB     25//15//10
#define EB_CE_CTL_1_WRSETUP    2//1    
#define EB_CE_CTL_1_WRHLD      2//1
#define EB_CE_CTL_1_WRHLDMSB   0
#define EB_CE_CTL_1_TA         1
...
#define EB_CE_SEC_1_SNCCLK     CESEC_ECLKOUT1
    ...
    //CE2 Space:
#define EB_CE_CTL_2_MTYPE      CECTL_ASYNC16
#define EB_CE_CTL_2_RDSTRB     2
#define EB_CE_CTL_2_RDSETUP    2
#define EB_CE_CTL_2_RDHLD      0
#define EB_CE_CTL_2_WRSTRB     2
#define EB_CE_CTL_2_WRSETUP    0    
#define EB_CE_CTL_2_WRHLD      0
#define EB_CE_CTL_2_WRHLDMSB   0
#define EB_CE_CTL_2_TA         1
#define EB_CE_SEC_2_SYNCRL     CESEC_2CYCLE
#define EB_CE_SEC_2_SYNCWL     CESEC_0CYCLE
...
#define EB_CE_CTL_3_RDSTRB     10
#define EB_CE_CTL_3_RDSETUP    1
#define EB_CE_CTL_3_RDHLD      1
#define EB_CE_CTL_3_WRSTRB     10
#define EB_CE_CTL_3_WRSETUP    1
#define EB_CE_CTL_3_WRHLD      1
#define EB_CE_CTL_3_WRHLDMSB   0
#define EB_CE_CTL_3_TA         1
...
// ---------------------------------------------------------------------------
extern MCBSP_Handle mcbsp_spi_init( int devNum );
// ---------------------------------------------------------------------------
void emif_m448_15_main_init()
{
    dnsd_hMcbsp = mcbsp_spi_init( MCBSP_DEV2 );
// --- External Memory Interface A -------------------------------------------
...
{
  { NULL, SYSCALL_EMIF_INIT, (uint32)&emif_m448_15_main_init }
};
