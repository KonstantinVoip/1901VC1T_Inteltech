#ifndef TESTS_NAME_711_H
#define TESTS_NAME_711_H
...
"44.Тест з/чт USB флэш3",	//-  
"45.Тест з/чт RAID1 SSD",	//-
"46.Тест чтения CD ROM",
"47.Целостность ПО ПП-56",

"48.Тест ОЗУ(SDRAM)ПП-56",	//---
...
TEST_IFACE test42 = {42, F_test_sk2, 
	NameTests[41],false, 1};
TEST_IFACE test43 = {43, F_test_sk3, 
	NameTests[42],false, 1};

TEST_IFACE test44 = {44, F_test_usb_flash3, 
	NameTests[43],true, 1};
TEST_IFACE test45 = {45, F_test_raid, 
	NameTests[44],true, 1};
TEST_IFACE test46 = {46, F_test_cdrom, 
	NameTests[45],true, 1};
TEST_IFACE test47 = {47, F_hash_comp_pp056, 
	NameTests[46],true, 1};
