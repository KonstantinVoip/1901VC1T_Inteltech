...
;----------------------------------------------------------------------
;  55 | Return Value: Общий Файл Старт os_main ТПО дл                          
;----------------------------------------------------------------------
...
;** --------------------------------------------------------------------------*
;----------------------------------------------------------------------
;  56 | [IFACE ,MAIN и COMM Процессоров]                                       
;----------------------------------------------------------------------
	.dwcfi	cfa_offset, 0
...
;     |                134                                                     
;  75 | cry_hash_init(hash_bp);   //не                                         
;  76 | вный вызов через таблицу SYSCALL ОС                                    
;  78 | //                                                                     
;  79 |    #ifdef IFACE //Интерфейсна                                          
;  80 | плата                                                                  
...
;----------------------------------------------------------------------
;  85 | #ifdef MAIN  //Центральный Процессор а где Спарка или одинаковое им    
;  86 | у них                                                                  
;----------------------------------------------------------------------
...
;----------------------------------------------------------------------
;  90 | //                                                                     
;  91 |     #ifdef COMM  //Коммуникационный процессоры  переменные определены в
;     |  tpo.h                                                                 
;----------------------------------------------------------------------
