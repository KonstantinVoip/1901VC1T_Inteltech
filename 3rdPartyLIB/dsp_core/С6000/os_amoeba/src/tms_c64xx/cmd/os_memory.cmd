...
MEMORY
{
  ...
  OS_DATA       : origin = 0x00004000, len = 0x00004000
  OS_CODE       : origin = 0x00008000, len = 0x00018000
  CODE          : origin = 0x00020000, len = 0x00010000
  MPAGE0        : origin = 0x00030000, len = 0x000d0000
}
