...
// !: d: центрального процессора m448-17.
// ---------------------------------------------------------------------------
#include <os.h>
#include <emif.h>
//============================================================================
...
#define EA_CE_CTL_0_RDSTRB     1
#define EA_CE_CTL_0_RDSETUP    1
#define EA_CE_CTL_0_RDHLD      1
#define EA_CE_CTL_0_WRSTRB     1
#define EA_CE_CTL_0_WRSETUP    1    
#define EA_CE_CTL_0_WRHLD      1
...
#define EA_CE_SEC_1_SYNCRL     CESEC_1CYCLE
...
#define EA_CE_SEC_1_SNCCLK     CESEC_ECLKOUT2
    ...
    //CE2 Space:
#define EA_CE_CTL_2_MTYPE      CECTL_SYNC64
...
#define EA_CE_SEC_2_SYNCRL     CESEC_1CYCLE//1
...
#define EA_CE_SEC_2_SNCCLK     CESEC_ECLKOUT2
    ...
    //CE3 Space:
#define EA_CE_CTL_3_MTYPE      CECTL_SYNC64
...
#define EA_CE_SEC_3_SYNCRL     CESEC_1CYCLE//1
...
#define EB_CE_CTL_0_RDSTRB     16//10
#define EB_CE_CTL_0_RDSETUP    2
#define EB_CE_CTL_0_RDHLD      2
#define EB_CE_CTL_0_WRSTRB     16//10
...
#define EB_CE_CTL_1_RDSTRB     25//15
#define EB_CE_CTL_1_RDSETUP    1
#define EB_CE_CTL_1_RDHLD      1
#define EB_CE_CTL_1_WRSTRB     25//15
#define EB_CE_CTL_1_WRSETUP    1    
#define EB_CE_CTL_1_WRHLD      1
...
#define EB_CE_CTL_2_RDSTRB     5
#define EB_CE_CTL_2_RDSETUP    2
#define EB_CE_CTL_2_RDHLD      0
#define EB_CE_CTL_2_WRSTRB     5
...
#define EB_CE_CTL_3_RDSTRB     5
#define EB_CE_CTL_3_RDSETUP    1
#define EB_CE_CTL_3_RDHLD      1
#define EB_CE_CTL_3_WRSTRB     5
...
{
  { NULL, SYSCALL_EMIF_INIT, (uint32)&emif_m448_17_main_init }
};
