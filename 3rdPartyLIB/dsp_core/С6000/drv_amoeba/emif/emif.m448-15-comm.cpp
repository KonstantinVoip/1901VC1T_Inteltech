...
// !: d: комуникационного процессора m448-15.
// ---------------------------------------------------------------------------
#include <os.h>
#include <emif.h>
...
#define EA_GBL_CTL_HOLDA       0                //R
    ...
    //CE0 Space:
#define EA_CE_CTL_0_MTYPE      CECTL_SYNC32
...
#define EA_CE_SEC_0_CEEXT      CESEC_INACTIVE//CESEC_ACTIVE
#define EA_CE_SEC_0_RENEN      CESEC_ADS
#define EA_CE_SEC_0_SNCCLK     CESEC_ECLKOUT2
    
    //CE1 Space:
#define EA_CE_CTL_1_MTYPE      CECTL_ASYNC8
#define EA_CE_CTL_1_RDSTRB     10
#define EA_CE_CTL_1_RDSETUP    1
#define EA_CE_CTL_1_RDHLD      1
#define EA_CE_CTL_1_WRSTRB     10
#define EA_CE_CTL_1_WRSETUP    1 
#define EA_CE_CTL_1_WRHLD      1
...
#define EA_CE_SEC_3_SYNCRL     CESEC_0CYCLE//CESEC_1CYCLE
#define EA_CE_SEC_3_SYNCWL     CESEC_0CYCLE
#define EA_CE_SEC_3_CEEXT      CESEC_INACTIVE//CESEC_ACTIVE
...
{
  { NULL, SYSCALL_EMIF_INIT, (uint32)&emif_m448_15_comm_init }
};
