...
// !: d: комуникационного процессора m448-17.
// ---------------------------------------------------------------------------
#include <os.h>
#include <emif.h>
...
#define EA_GBL_CTL_HOLDA       0                //R
    ...
    //CE0 Space:
#define EA_CE_CTL_0_MTYPE      CECTL_SYNC64
...
#define EA_CE_CTL_1_RDSTRB     63
#define EA_CE_CTL_1_RDSETUP    1
#define EA_CE_CTL_1_RDHLD      3
#define EA_CE_CTL_1_WRSTRB     63
#define EA_CE_CTL_1_WRSETUP    1 
#define EA_CE_CTL_1_WRHLD      7
...
{
  { NULL, SYSCALL_EMIF_INIT, (uint32)&emif_m448_17_comm_init }
};
