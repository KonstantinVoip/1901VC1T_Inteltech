...
// ---------------------------------------------------------------------------
int32 modsyn_m448i15_error( int32 error )
{
  // Local definitions
...
// ---------------------------------------------------------------------------
int32 modsyn_m448i15_init( int32 v, uint32 tmo_ms, void (*cbfail)(int32) )
{
...
// ---------------------------------------------------------------------------
int32 modsyn_m448i15_open_close( uint16 pid )
{
  return OSE_OK;
}
// ---------------------------------------------------------------------------
int32 modsyn_m448i15_time_s( uint32* tm_s )
{
  (*tm_s) = time_s();
  return OSE_OK;
}
// ---------------------------------------------------------------------------
int32 modsyn_m448i15_time_m( uint64* tm_m )
{
  (*tm_m) = time_m();
  return OSE_OK;
}
// ---------------------------------------------------------------------------
int32 modsyn_m448i15_time_u( uint64* tm_u )
{
  (*tm_u) = time_u();
  return OSE_OK;
}
// ---------------------------------------------------------------------------
int32 modsyn_m448i15_time_core( uint64* tm_u )
{
  (*tm_u) = time_core();
  return OSE_OK;
}
// ---------------------------------------------------------------------------
int32 modsyn_m448i15_read_osts( uint32* osts0_m0, uint32* osts1_m0, uint32* osts0_m1, uint32* osts1_m1 )
{
...
// ---------------------------------------------------------------------------
int32 modsyn_m448i15_data( void* data, uint32 length, int32 prcn )
{
  if( length > 512 ) return OSE_TOO_MANY_DATA;
  return OSE_OK;
}
// ---------------------------------------------------------------------------
int32 modsyn_m448i15_wait_tm(uint64 timeout_us)
{
  return OSE_OK;
}
// ---------------------------------------------------------------------------
...
{
  { NULL, SYSCALL_SYN_INIT,      (uint32)&modsyn_m448i15_init       },
  { NULL, SYSCALL_SYN_OPEN,      (uint32)&modsyn_m448i15_open_close },
  { NULL, SYSCALL_SYN_CLOSE,     (uint32)&modsyn_m448i15_open_close },
  { NULL, SYSCALL_SYN_BEGIN,     (uint32)&modsyn_m448i15_begin      },
  { NULL, SYSCALL_SYN_END,       (uint32)&modsyn_m448i15_end        },
  { NULL, SYSCALL_SYN_TIME_S,    (uint32)&modsyn_m448i15_time_s     },
  { NULL, SYSCALL_SYN_TIME_M,    (uint32)&modsyn_m448i15_time_m     },
  { NULL, SYSCALL_SYN_TIME_U,    (uint32)&modsyn_m448i15_time_u     },
  { NULL, SYSCALL_SYN_TIME_CORE, (uint32)&modsyn_m448i15_time_core  },
  { NULL, SYSCALL_SYN_READ_OSTS, (uint32)&modsyn_m448i15_read_osts  },
  { NULL, SYSCALL_SYN_DATA,      (uint32)&modsyn_m448i15_data       },
  { NULL, SYSCALL_SYN_ERROR,     (uint32)&modsyn_m448i15_error      },
  { NULL, SYSCALL_SYN_WAIT_TM,   (uint32)&modsyn_m448i15_wait_tm    }
};
